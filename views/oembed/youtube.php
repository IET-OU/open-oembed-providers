...
<div class='youtube embed-rsp'><iframe title='<?php echo t('YouTube video player') ?>' width='<?php echo $width ?>' height='<?php echo $height ?>'
 ...
 src='<?php echo $embed_url ?>?theme=<?php echo $theme ?>&amp;fs=1&amp;cc_load_policy=1&amp;origin=<?php echo $this->input->server('HTTP_HOST'); ?>'><?php echo t('Your browser does not support frames.') ?>
